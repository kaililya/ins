        ...
        >
          <ul className={styles.nav_list}>
            <li className={`${styles.nav_item} ${styles.nav_item_dropdown}`}>
              <div
                onClick={handelClickTitleSoftware}
                className={`${styles.links_container_columns} ${styles.links_container_columns__header}`}
              >
                <p className={`${styles.link} ${styles.link__mobile_bottom}`} >Software</p>
                <ul
                  style={{display: isSoftware && 'block'}}
                  className={`${styles2.link_column} ${styles.link_column__header}`}
                >
                  <li className={`${styles.link__header}`}>
                    <NavLink
                      className={switchClassNameMinorLink}
                      to={funktionenPATH}
                      onClick={handleRoute}
                    >
                      Funktionen
            ...
            <li className={`${styles.nav_item} ${styles.nav_item_dropdown}`}>
              <div
                ...
                className={`${styles.links_container_columns}
                 ${styles.links_container_columns__header}`}
              >
                <p className={styles.link}>Aktuelles</p>
                <ul
                  style={{display: isAktuelles && 'block'}}
                  className={`${styles2.link_column} ${styles.link_column__header}`}
                >
                  <li className={`${styles.link__header}`}>
                    <NavLink
          ...
          >
            <NavLink style={{ textDecoration: "none" }} to={kontaktPATH}>
              <button className={styles.button_contact} onClick={handleRoute}>
                Kontakt
              </button>
            </NavLink>
            <Link to={"http://app.compleon-solutions.de"}>
              <img
