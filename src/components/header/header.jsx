...
const Header = () => {
  ...
  return (
    ...
    >
      <div className={pathname === '/' ? `${styles.header_wrapper_main}` : `${styles.header_wrapper}`}>
        <NavLink aria-label="link to main page" to="/" className={styles.fff} onClick={handleRoute}>
