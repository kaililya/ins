...
const Header = () => {
  ...
  const switchClassNameMainLink = ({isActive}) => (isActive ? `${styles.link_active} ${styles.link}` : `${styles.link}`);
  const switchClassNameMinorLink = ({isActive}) => (isActive ? `${styles.link_active} ${styles.link}` : `${styles.link}`);
  ...
  return (
    ...
    >
      <div className={styles.header_wrapper}>
        <NavLink to='/' className={styles.fff}>
          <svg
            viewBox="0 0 333 68"
            fill="none"
        ...
        >
          <ul className={styles.nav_list}>
            ...
            <li className={`${styles.nav_item} ${styles.nav_item_dropdown}`}>
              <li className={`${styles2.links_container_columns} ${styles.links_container_columns__header}`}>
                <NavLink className={switchClassNameMainLink} to="#">
                  Aktuelles
                </NavLink>
                <ul className={`${styles2.link_column} ${styles.link_column__header}`}>
          ...
          >
            <NavLink style={{ 'textDecoration': 'none'}} to={"profilePATH"}>
              <button className={styles.button_contact}>Kontakt</button>
            </NavLink>
            <Link
              to={""}
        ...
        <div className={styles.right_nav_container}>
          ...
          <Link
            ...
            // state={{ background: location }}
          >
            <img className={styles.right_nav_image} src={userSquare} alt=" " />
          </Link>
        </div>
        <button
          className={
